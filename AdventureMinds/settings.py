"""
Django settings for AdventureMinds project.
...
SECRET_KEY = "django-insecure-z)p!^5#lfet3hqq!d1m&+2_^%(45ytg@mi-ry6u6^s3+m8fmgx"
...
WSGI_APPLICATION = "AdventureMinds.wsgi.application"
